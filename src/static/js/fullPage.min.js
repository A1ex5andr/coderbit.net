...
$(document).ready(function(){
    // to run animation on skills li only once
    ...
    if (isMobile.any()) {
        ...
        $('#slideBlocks').fullpage({
            ...
            afterLoad: function(anchorLink, index){
                // show first slide on index 2 slide == web section
                if(index == 2){
                    $('.web-html .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true}});
                };

                // animate skills li only once
                if(index == 3 && !skillsShown){
            ...
            afterSlideLoad: function(anchorLink, index, slideAnchor, slideIndex){
                if (slideIndex == 1){
                    $('.web-css .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true}});
                };
                if (slideIndex == 2){
                    $('.web-js .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true}});
                };
                if (slideIndex == 3){
                    $('.web-photoshop .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true}});
                };
                if (slideIndex == 4){
                    $('.web-illustrator .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true}});
                };
            },
        ...
        $('#slideBlocks').fullpage({
            ...
            afterLoad: function(anchorLink, index){
                ...
                if(index == 2){
                    $('.web-html .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true},
                        callback: function () { $('.web-html .example').fadeIn(500); }
                    });
                };
            ...
            afterSlideLoad: function(anchorLink, index, slideAnchor, slideIndex){
                if (slideIndex == 1){
                    $('.web-css .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true},
                        callback: function () { $('.web-css .example').fadeIn(500); }
                    });
                };
                if (slideIndex == 2){
                    $('.web-js .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true},
                        callback: function () { $('.web-js .example').fadeIn(500); }
                    });
                };
                if (slideIndex == 3){
                    $('.web-photoshop .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true},
                        callback: function () { $('.web-photoshop .example').fadeIn(500); }
                    });
                };
                if (slideIndex == 4){
                    $('.web-illustrator .animateText').textillate({ in: { effect: 'bounceIn', delayScale: delayScale, delay:  delay, shuffle: true},
                        callback: function () { $('.web-illustrator .example').fadeIn(500); }
                    });
                };
            },
            onSlideLeave: function(anchorLink, index, slideIndex, direction){}

...
$(document).ready(function() {
    ...
    //loop video
    $("#mainVideo video").on('ended', function() {
//        console.log("I'm done!");
    ...
    new ScrollScene({triggerElement: "#parallax1"})
        ...
        .addTo(controller)
//        .addIndicators({zindex: 1, suffix: "1"}); //for debug

    //news blocks bg
    // build tween
    var tween = TweenMax.to(".news-bl-item", 1, {backgroundColor: "white"});
    // build scene
    var scene = new ScrollScene({triggerElement: "#triggerAnimateWhite"})
        .setTween(tween)
        .addTo(controller);
    // show indicators (requires debug extension)
//    scene.addIndicators(); // for debug

...
console.log('current - ' + $(window).width());
...
var Grid = (function() {
    ...
    function initEvents() {
        ...
        $window.on( 'debouncedresize', function() {
            ...
            console.log('var - ' + winWidth);

            if ($window.width() != winWidth) { //run hide function only on width change
                if( typeof preview != 'undefined' ) {
                    //hidePreview();
                }
                winWidth = $(window).width(); //change old width dara with new
                console.log('Var after resave - ' + winWidth);
            }
